...
Thank you to my family, especially my parents, for their steadfast support over the past four years. I would not have made it here had you not pushed me to wholeheartedly pursue my interest in statistics. I am And to Professor Zhou, thank you for your guidance and insight over the past few months. Your kind mentorship has meant a lot to me and sets a great example for how I hope to interact with my peers (and perhaps my students) in the future. 
\end{centering}
...
\subfloat[$N = 50$]{\includegraphics[width=.45\linewidth]{Imgs/Sparse Logistic Regression/test_error_50.png}}
\caption{Average test accuracy versus epoch for $K=20$ gradient descent paths. The three paths correspond to initialization scales $r_w = r_{\boldsymbol{u}} = 1$ (blue), $10^{-1}$ (orange), and $10^{-2}$ (green).}\label{fig:testerrlogistic}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics{Imgs/Sparse Logistic Regression/net_param_l1_avg.png}
    \caption{}
    \label{}
\end{figure}
